...
loc1 <- geocode(addresses[1:50])
loc2 <- geocode(addresses[51:100])
loc3 <- geocode(addresses[101:150])
loc4 <- geocode(addresses[151:200])
loc5 <- geocode(addresses[201:250])
loc6 <- geocode(addresses[251:300])
loc7 <- geocode(addresses[301:345])
locs <- rbind(loc1, loc2, loc3, loc4, loc5, loc6, loc7)
